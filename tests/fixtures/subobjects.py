...
def complex_computation_forcefield() -> cript.ComputationalForcefield:
    """
...
@pytest.fixture(scope="function")
def complex_computation_forcefield_node(simple_data_node, complex_citation_node) -> cript.ComputationalForcefield:
