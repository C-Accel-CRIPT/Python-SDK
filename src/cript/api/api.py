...
from cript.api.utils.helper_functions import (
...
class API:
    ...
    def delete_node_by_uuid(self, node_type: Union[Any, str], node_uuid: str) -> None:
        ...
        None
        """
        node_type_snake_case: str = get_node_type_snake_case(node_type=node_type)

        delete_node_api_url: str = f"{self._host}/{node_type_snake_case}/{node_uuid}/"
        ...
        self.logger.info(f"Deleted '{node_type_snake_case.title()}' with UUID of '{node_uuid}' from CRIPT API.")
