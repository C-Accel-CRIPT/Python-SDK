...
def test_integration_algorithm(cript_api, simple_project_node, simple_collection_node, simple_experiment_node, simple_computation_node, complex_software_configuration_node, complex_algorithm_node):
    """
