...
with cript.API(host=Config.host, api_token=Config.api_token, storage_token=Config.storage_token) as api:  # "https://stage.mycriptapp.org/",
    ...
    if hasattr(cript, class_name):
        ...
        # my_project_name = "my Project name ali"
        # project = cript.Project(name=my_project_name)
        ...
        print("\n----project.material.get_json()")
        print([item.get_json().json for item in project.material])
        ...
        # TOTALLY RESET
        project.material = [material_001, material_002]
        # ------------------------
        ...
        print("----- printing project 2 after we changed \n")
        print(project.get_json().json)
